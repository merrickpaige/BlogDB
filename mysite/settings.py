...
STATIC_ROOT = os.path.path.join(BASE_DIR, 'staticfiles')
STATIC_URL = '/static/'
...
#MEDIA_ROOT = os.path.path.join(BASE_DIR, 'media')
#MEDIA_URL = '/media/'
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'paigescreation1@gmail.com'
#SERVER_EMAIL = 'paigescreation1@gmail.com'
EMAIL_HOST_PASSWORD = 'hhmvxbetaewepuov'
